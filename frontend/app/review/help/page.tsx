  ...
  return (
    <main className={styles.page}>
      <div className={styles.shell}>
        ...
        <div className={styles.sectionHeader}><div><h2>四種進度，不要混在一起</h2><p>平台刻意分開記錄，避免「播到後面」被誤認為「學會」或「校完字幕」。</p></div></div>
        <section className={styles.panel}>
          <div className={styles.stats}>
            <div className={styles.statCard}><strong>▶</strong><span>播放位置：下次從哪裡接著看</span></div>
          ...
          <p className={styles.muted}>影片播放到最後，不會自動標記為「已學完」；學習完成也不代表你已經完成字幕校訂。畫面上的百分比主要幫你辨識上次播放到影片哪個位置，不等於系統證明你逐秒觀看過。</p>
        </section>
        ...
        <section className={styles.twoColumn}>
          ...
          <div className={styles.panel}><h2>問答／Flashcards／測驗</h2><p>用不同方式重新叫回記憶。Flashcards 可回報「再來一次／有點難／記得／很熟」，測驗成績會留下紀錄，而且由系統依正式題目重新計分。</p></div>
          <div className={styles.panel}><h2>我的筆記</h2><p>保存你自己的理解、疑問與提醒，和 AI 筆記分開。筆記可以連到當時的影片時間；到「我的筆記與書籤」還能跨課程搜尋、編輯或刪除自己的內容。</p><a href="/review/learn/notes">整理我的筆記與書籤 →</a></div>
        ...
        <section className={styles.panel}>
          <div className={styles.list}>
            <div className={styles.listItem}><strong>影片看完會自動變成「已學完」嗎？</strong><p>不會。學習完成需要你自己按「我已學完」，避免單純播放到最後被誤判成真正完成學習。</p></div>
            <div className={styles.listItem}><strong>畫面的觀看百分比代表我真的看了那麼多嗎？</strong><p>它主要表示你的播放位置，方便下次接著看；不是防快轉或逐秒出席證明。真正的「已學完」仍由你主動標記。</p></div>
            ...
            <div className={styles.listItem}><strong>我換手機或電腦，可以接著學嗎？</strong><p>可以。使用同一個已連結的登入身分後，播放位置、學習狀態、個人筆記、書籤與共修紀錄都會跟著帳號。</p></div>
        ...
        <section className={styles.panel}>
          <div className={styles.cardActions} style={{maxWidth:760}}>
            <a className={styles.openButton} href="/review/learn">前往我的學習中心</a>
            <a className={styles.reviewButton} href="/review/learn/notes">我的筆記與書籤</a>
