...
export default function JobDetailPage({ jobId }: { jobId: string }) {
  ...
  const publishLabel = job.drivePublished ? "已輸出至原始資料夾" : "QA 完成後自動輸出";
