...
export AI_RUNTIME_HOST_DIR="/opt/course-transcript/secrets/ai-runtime"
export AI_ACCOUNTS_DIR="/opt/course-transcript/secrets/ai-accounts"
...
PY
  ...
  COURSE_TRANSCRIPT_ACTIVE_PROJECT="${ACTIVE_AI_VALUES[0]:-}"
