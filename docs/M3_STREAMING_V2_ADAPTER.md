...
5. inherited correction schema validation succeeds;
6. segment IDs are complete and unchanged;
7. content guard passes or falls back that segment to immutable Chirp raw text.
